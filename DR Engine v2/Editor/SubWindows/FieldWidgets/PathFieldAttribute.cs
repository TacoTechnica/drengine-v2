...
namespace DREngine.Editor.SubWindows.FieldWidgets
{
    ...
    {
        public DirectoryFieldAttribute(string title = "Choose Directory", string filter=null, string filterName=null) : base(title, filter, filterName) { }
    ...
    {
        public FileFieldAttribute(string title = "Choose File", string filter=null, string filterName=null) : base(title, filter, filterName) { }
        public override IFieldWidget GetOverrideWidget(DREditor editor, FieldInfo field)
        {
    ...
    public class EngineFileFieldAttribute : FileFieldAttribute
    {
        ...
        public EngineFileFieldAttribute(string relativePath, string title="Choose File", string filter=null, string filterName=null) : base(title, filter, filterName)
        {
    ...
    public class EngineDirectoryFieldAttribute : DirectoryFieldAttribute
    {
        ...
        public EngineDirectoryFieldAttribute(string relativePath, string title="Choose File", string filter=null, string filterName=null) : base(title, filter, filterName)
        {
            RelativePath = relativePath;
        }
        protected override string GetStatPath(DREditor editor)
